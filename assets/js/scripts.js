            ...
            if ($(this).hasClass("active")) {
                ...
                if ($(".chatapi-windows #user-window" + id).length) {
                   ...
                   // var msg = chatformat_msg('Wow! What a Beautiful theme!', 'receive', name);
                    ...
                    html += "<form method='POST' class='chatForm'><div class='controlbar'><img src='" + img + "' data-user-id='" + id + "' rel='tooltip' data-animate='animated fadeIn' data-toggle='tooltip' data-original-title='" + name + "' data-placement='top' data-color-class='primary'><span class='status " + status + "'><i class='fa fa-circle'></i></span><span class='name'>" + name + "</span><span class='opts'><i class='fa fa-times closeit' data-user-id='" + id + "'></i><i class='fa fa-minus minimizeit' data-user-id='" + id + "'></i></span></div>";
                    html += "<div class='chatarea'></div>";
                    html += "<div class='typearea'><input type='text' name='chating' data-user-id='" + id + "' placeholder='Type & Enter' class='form-control'></form></div>";
                    html += "</div>";
